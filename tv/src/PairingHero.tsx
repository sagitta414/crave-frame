...
export function PairingHero({pair,source,pending=false,watchArt,onChoose,onDetails,onSearch,position=0,count=1,onPosition}:any){
 ...
 <View style={[s.copy,{paddingHorizontal:wide?56:24,paddingTop:wide?20:24,paddingBottom:20,width:wide?'72%':'100%'}]}>
 ...
 <View style={s.actions}><Button primary preferred focusKey="hero-choose" onPress={()=>onChoose(pair)}>{matched?'Plan this evening':'Find its dinner'}</Button><Button focusKey="hero-search" onPress={onSearch}>Choose what to watch</Button></View>
